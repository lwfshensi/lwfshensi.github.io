  ...
  module Jdbc
    ...
    def execute_statement
      ...
      begin
        ...
        @logger.info("begin subquery:#{sum_statement}")
        @statement_handler.perform_query(@database, @value_tracker.value, @jdbc_paging_enabled, @jdbc_page_size,@subquery_paging_enabled,@sum_statement,@logger) do |row|
